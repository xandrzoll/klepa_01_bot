...
from settings import (
    TINKOFF_TOKEN,
    TINKOFF_TOKEN_TRADE,
    TINKOFF_TRADE_ACCOUNT,
    TINKOFF_WATCH_ACCOUNT,
    TINKOFF_COPY_ACCOUNT,
    TG_BOT,
    TG_CHAT_IDS,
)
...
WEBHOOK_PATH = f"/bot/{TG_BOT}"
WEB_SERVICE_NAME = "klepa.site/"
WEBHOOK_URL = "https://" + WEB_SERVICE_NAME + WEBHOOK_PATH
